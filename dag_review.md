...
default_args = {
    'owner': 'data_eng',
    'start_date': datetime(2023, 1, 1),
    'depends_on_past': False, # тк нестабильное соединение 'depends_on_past' лучше поставить на фалсе или убрать тк он по дефолту FALSE тк если есть парамент 'depends_on_past' таска запустится только если предыдущий экземпляр этой таски успешно завершился
    'retries': 4, #уменишли
